...
/*funcation is callled isNUnique*/
    public static  int isNUnique(int[]a,int n){
        ...
        int isNUnique = 0 ;
        /* we are looking for aleast two elements in the array to run this funcation the funcation */
        if(a.length >2){
            ...
            for(int indext= 0;indext< a.length;indext++){
                ...
                for(int innerIndex=indext+1 ; innerIndex<a.length;innerIndex++ ){
                    ...
                    if(a[indext]+a[innerIndex] == n){
                        /*if two pair array are equal then we count the how many times appers in the array*/
